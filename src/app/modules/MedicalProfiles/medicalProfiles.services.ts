...
const createMedicalProfile = async (medicalProfile: MedicalProfile): Promise<MedicalProfile> => {
...
const getSingleMedicalProfile = async (id: string): Promise<MedicalProfile | null> => {
...
const updateMedicalProfile = async (id: string, medicalProfile: MedicalProfile): Promise<MedicalProfile> => {
